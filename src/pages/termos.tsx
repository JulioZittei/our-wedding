...
const HeaderTerms = styled('header', TermosCss.Header);
        ...
        <Root>
          <Container>
            ...
            >
              ...
              <Paragraph>
                Para acessar o conteúdo do Site da <strong>elenejulio.com</strong>, pode ser solicitado ao usuário
                algumas informações pessoais como nome, email e outros. Se acharmos que as informações não são corretas
                ou verdadeiras, temos o direito de recusar e/ou cancelar o acesso a qualquer tempo, sem notificação
                prévia.
              </Paragraph>
              ...
              <Paragraph>
                Você só poderá usar este Site da <strong>elenejulio.com</strong> para propósitos permitidos por nós.
                Você não poderá usá-lo em qualquer outro objetivo, especialmente comercial, sem o nosso consentimento
                prévio. Não associe nossas marcas a nenhuma outra. Não exponha nosso nome, logotipo, logomarca entre
                outros, indevidamente e de forma a causar confusão.
              </Paragraph>
              ...
              <Paragraph>
                É proibido usar qualquer serviço ou ferramenta conectada a este site para comprometer a segurança ou
                mexer com os recursos do sistema e/ou contas. O uso ou distribuição de ferramentas destinadas para
                comprometer a segurança (ex: programas para descobrir senha, ferramentas de crack ou de sondagem da
                rede) são estritamente proibidos. Se você estiver envolvido em qualquer violação da segurança do
                sistema, o Site se reserva o direito de fornecer suas informações para os administradores de sistema de
                outros sites para ajudá-los a resolver incidentes de segurança. O Site se reserva o direito de
                investigar potenciais violações a esse Termo de Uso.
              </Paragraph>
              ...
              <Paragraph>
                ...
                Site serão tratadas em concordância com a Lei da Proteção de Dados Pessoais de 26 de outubro de 1998
                (Lei n.º 67/98).
              </Paragraph>

              <Paragraph>
                As informações pessoais recolhidas podem incluir o seu nome, email, número de telefone e/ou celular,
                idade e/ou outros.
              </Paragraph>

              <Paragraph>
                O uso da <strong>elenejulio.com</strong> pressupõe a aceitação deste Acordo de Privacidade. A equipe da{' '}
                <strong>elenejulio.com</strong> reserva-se ao direito de alterar este acordo sem aviso prévio. Deste
                modo, recomendamos que consulte a nossa política de privacidade com regularidade de forma a estar sempre
                atualizado.
              </Paragraph>
            </Article>
          </Container>
